...
local function filter(kind: string, ...: string): any
	return { kind = kind, components = { ... } }
end

function QueryEngine.All(...: string): any
	return filter("all", ...)
end

function QueryEngine.Any(...: string): any
	return filter("any", ...)
end

function QueryEngine.None(...: string): any
	return filter("none", ...)
end

function QueryEngine.Changed(...: string): any
...
local function bind(stores: any, names: { string }): { any }
